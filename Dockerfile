...
RUN debconf shared/accepted-oracle-license-v1-1 select true | /usr/bin/debconf-set-selections

RUN debconf shared/accepted-oracle-license-v1-1 seen true | /usr/bin/debconf-set-selections
